...
all:: container proto_go build_cni

.PHONY: container
container: dirmake update_modules libbpf proto
...
.PHONY: build_cni
build_cni:
	cd cmd/mizarcni/main; go mod init mizar-cni; go build; mv mizar-cni ../../../build/bin; rm go.*
