...
#		config.load_incluster_config()
	...
	def create_pod(self, name):
		...
		resp = self.api_instance.create_namespaced_pod(body=pod_manifest, namespace='default')

		status = None 
		while status != 'Running':
			resp = self.api_instance.read_namespaced_pod(name=name, namespace='default')
