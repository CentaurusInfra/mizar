...
class test_basic_vpc(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.subnet1 = self.api.create_net(subnet_name, "12.2.0.0", "16", vpc_name, vpc["vni"])
        self.subnet2 = self.api.create_net(subnet2_name, "12.4.0.0", "16", vpc_name, vpc["vni"])
        self.api.get_net(subnet_name)
        self.api.get_net(subnet2_name)
        self.ep1 = self.api.create_pod(self.test_name + "ep1", vpc_name, subnet_name)
        self.ep2 = self.api.create_pod(self.test_name + "ep2", vpc_name, subnet_name)
        self.ep3 = self.api.create_pod(self.test_name + "ep3", vpc_name, subnet2_name)
