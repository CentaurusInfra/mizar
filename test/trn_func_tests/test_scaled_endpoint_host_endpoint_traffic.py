...
class test_scaled_endpoint_host_endpoint_traffic(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ep0 = self.c.create_host_endpoint(3, 1, "10.0.0.2", "d1")
    ...
    def test_scaled_endpoint_host_endpoint_traffic(self):
