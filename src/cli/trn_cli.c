...
static const struct cmd {
	...
	{ "update-network-policy-ingress", trn_cli_update_network_policy_ingress_subcmd },
	{ "update-network-policy-egress", trn_cli_update_network_policy_egress_subcmd },
	{ "update-network-policy-protocol-port-ingress", trn_cli_update_network_policy_protocol_port_ingress_subcmd },
	{ "update-network-policy-protocol-port-egress", trn_cli_update_network_policy_protocol_port_egress_subcmd },
	{ "update-network-policy-enforcement-map-ingress", trn_cli_update_network_policy_enforcement_map_ingress_subcmd },
	{ "update-network-policy-enforcement-map-egress", trn_cli_update_network_policy_enforcement_map_egress_subcmd },
	...
	{ "delete-network-policy-ingress", trn_cli_delete_network_policy_ingress_subcmd },
	{ "delete-network-policy-egress", trn_cli_delete_network_policy_egress_subcmd },
	{ "delete-network-policy-protocol-port-ingress", trn_cli_delete_network_policy_protocol_port_ingress_subcmd },
	{ "delete-network-policy-protocol-port-egress", trn_cli_delete_network_policy_protocol_port_egress_subcmd },
	{ "delete-network-policy-enforcement-map-ingress", trn_cli_delete_network_policy_enforcement_map_ingress_subcmd },
	{ "delete-network-policy-enforcement-map-egress", trn_cli_delete_network_policy_enforcement_map_egress_subcmd },
