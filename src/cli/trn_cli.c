...
static const struct cmd {
	...
	{ "update-ingress-network-policy-rule", trn_cli_update_network_policy_ingress_subcmd },
	{ "update-egress-network-policy-rule", trn_cli_update_network_policy_egress_subcmd },
	{ "update-ingress-network-policy-protocol-port-rule", trn_cli_update_network_policy_protocol_port_ingress_subcmd },
	{ "update-egress-network-policy-protocol-port-rule", trn_cli_update_network_policy_protocol_port_egress_subcmd },
	{ "update-ingress-network-policy-enforcement-map", trn_cli_update_network_policy_enforcement_map_ingress_subcmd },
	{ "update-egress-network-policy-enforcement-map", trn_cli_update_network_policy_enforcement_map_egress_subcmd },
	...
	{ "delete-ingress-network-policy-rule", trn_cli_delete_network_policy_ingress_subcmd },
	{ "delete-egress-network-policy-rule", trn_cli_delete_network_policy_egress_subcmd },
	{ "delete-ingress-network-policy-protocol-port-rule", trn_cli_delete_network_policy_protocol_port_ingress_subcmd },
	{ "delete-egress-network-policy-protocol-port-rule", trn_cli_delete_network_policy_protocol_port_egress_subcmd },
	{ "delete-ingress-network-policy-enforcement-map", trn_cli_delete_network_policy_enforcement_map_ingress_subcmd },
	{ "delete-egress-network-policy-enforcement-map", trn_cli_delete_network_policy_enforcement_map_egress_subcmd },
