...
static const struct cmd {
	...
	{ "update-network-policy-enforcement-map", trn_cli_update_network_policy_enforcement_map_subcmd },
	...
	{ "delete-network-policy-enforcement-map", trn_cli_delete_network_policy_enforcement_map_subcmd },
