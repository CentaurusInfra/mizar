...
import (
	...
	"mizar.com/crds-operator-proxy/crds/bouncers/apis/generated/clientset/versioned/scheme"
...
func (c *MizarV1Client) Bouncers(namespace string) BouncerInterface {
	return newBouncers(c, namespace)
}
