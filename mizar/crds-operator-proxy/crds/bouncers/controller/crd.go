...
func (c *Controller) doesCRDExist() (bool, error) {
	crd, err := c.apiextensionsclientset.ApiextensionsV1beta1().CustomResourceDefinitions().Get(bouncerv1.Name, metav1.GetOptions{})
...
func (c *Controller) CreateCRD() error {
	...
	crd := &apiextensions.CustomResourceDefinition{
		...
		Spec: apiextensions.CustomResourceDefinitionSpec{
			Group:   bouncerv1.GroupName,
			Version: bouncerv1.Version,
			Scope:   apiextensions.NamespaceScoped,
			Names: apiextensions.CustomResourceDefinitionNames{
				Plural:     bouncerv1.Plural,
				Singular:   bouncerv1.Singluar,
				Kind:       bouncerv1.Kind,
				ShortNames: []string{bouncerv1.ShortName},
			},
